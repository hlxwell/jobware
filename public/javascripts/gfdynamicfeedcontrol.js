...
GFdynamicFeedControl.prototype.createSubContainers_ = function() {
  ...
  if (this.options.horizontal) {
    ...
    nodes.branding.innerHTML = "<table  style='margin-left: 0px; font-size: 11px'><tr><td style='padding: 0px; text-align: center;'>Powered by</td></tr><tr><td style='padding: 0px; text-align: center;'>ITJob.fm</td></tr></table>";
